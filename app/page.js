...
function calculateVehicleCosts(profile) {
  ...
  const netPrice =
    orderCosts *
    (1 + numberValue(profile.profitPercent) / 100);
...
export default function Home() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("cockpit-clean-v3");
  ...
  useEffect(() => {
    if (loaded) {
      localStorage.setItem("cockpit-clean-v3", JSON.stringify(data));
    }
  }, [data, loaded]);
  ...
  function resetDemo() {
    ...
    localStorage.removeItem("cockpit-clean-v3");
    setData(INITIAL_DATA);
                ...
                <div className="cost-section">
                  ...
                  <div className="calculation-input-grid">
                    ...
                    <CalculationInput
                      ...
                      value={selectedCalculationProfile.profitPercent}
                      suffix="%"
                      step="1"
                      onChange={(value) =>
                        updateCalculation("profitPercent", value)
                      }
                    />
                    <CalculationInput
              ...
              <div className="price-cards">
                <article className="price-card net">
                  <span>
                    Nettopreis inkl.{" "}
                    {numberValue(
                      selectedCalculationProfile.profitPercent
